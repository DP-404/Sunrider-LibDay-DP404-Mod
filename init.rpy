...
define pro = Character(_('PROTOTYPE')    , what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed")
...
define wan = Character(_('WANDERER')     , what_outlines=[(3, "#000000", 1, 1),(2, "#3b3d66", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#3b3d66", 0, 0)],ctc="ctc",ctc_position="fixed")
...
define cre1 = Character(_('CREWMAN1')    , what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed")
define cre2 = Character(_('CREWMAN2')    , what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed")
define cre3 = Character(_('CREWMAN3')    , what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed")
...
define com = Character(_('COMM')         , what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed")
define kayo = Character(_('PAST KAYTO')  , what_outlines=[(3, "#000000", 1, 1),(2, "#575757", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#575757", 0, 0)],ctc="ctc",ctc_position="fixed")
define unp = Character(_('UNKNOWN PILOT'), what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed")
...
# Syntax: Use init 2+ python
 ...
 # Validateing:
    ...
    setoptions = [
    [1,"Flag","After the fall of Cera, which flag did you suggest flying?","True","Bandera","Después de la caída de Cera, ¿qué bandera sugeriste volar?"],
    [2,"Cera","You told Ava the Sunrider would always fly Cera's flag.","True",("his_ceraflag",True),"Cera","Le dijiste a Ava que el Sunrider siempre volaría la bandera de Cera."],
    [2,"Pirate","You told Ava being a pirate ship wouldn't be bad.","True",("his_ceraflag",False),"Pirata","Le dijiste a Ava que una nave pirata no estaría mal."],
    
    [1,"Reunion with Ava","How did you treat Ava upon reuniting with her\nafter ten years?","True","Reunión con Ava","¿Cómo trataste a Ava tras reunirte con ella\ndespués de diez años?"],
    [2,"Professional","You were professional with Ava.","True",("his_professionalreunion",True),"Profesional","Fuiste profesional con Ava."],
    [2,"Friendly","You told Ava that it'll be just like old times.","True",("his_professionalreunion",False),"Amistoso","Le dijiste a Ava que sería como en los viejos tiempos."],
    
    [1,"Military discipline","Who did you support after meeting Asaga and Chigara\nat Tydaria?","True","Disciplina militar","¿A quién apoyaste tras conocer a Asaga y a Chigara\nen Tydaria?"],
    [2,"Relaxed rules","You loosened up the rules for Asaga.","True",("his_loosenrule",True),"Reglas relajadas","Aflojaste las reglas por Asaga."],
    [2,"Enforced discipline","You supported Ava's enforcement of military discipline.","True",("his_loosenrule",False),"Disciplina forzosa","Apoyaste la ejecución de la disciplina militar de Ava."],
    
    [1,"First side job","Which first side job did you perform?","True","Primer trabajo lateral","¿Cuál fue el primer trabajo lateral que realizaste?"],
    [2,"PACT Spire","You attacked the PACT communication spire.","True",("his_pactspire",True),"Aguja del PACT","Atacaste la aguja de comunicaciones del PACT."],
    [2,"Human traffickers","You stopped the human traffickers.","True",("his_pactspire",False),"Traficantes humanos","Detuviste a los traficantes humanos."],
    
    [1,"Fate of the Traffickers","What did you do with the captured human traffickers?","his_pactspire == False","Destino de los traficantes","¿Qué hiciste con los traficantes humanos capturados?"],
    [2,"Taken alive","You captured them and turned them over to the authorities.","his_pactspire == False",("his_capturetraffickers",True),"Tomarlos vivos","Los capturaste y los llevaste ante las autoridades."],
    [2,"Killed","You left them to die slowly in space.","his_pactspire == False",("his_capturetraffickers",False),"Matarlos","Los dejaste morir en el espacio lentamente."],
    
    [1,"Versta diplomats","What happened to the Alliance diplomats at Versta?","True","Diplomáticos de Versta","¿Qué les sucedió a los diplomáticos de la Alianza en Versta?"],
    [2,"Saved","You saved the diplomats.","True",("his_diplomatssaved",True),"Salvados","Salvaste a los diplomáticos."],
    [2,"Killed","The Agamemnon was sank and all lives onboard were lost.","True",("his_diplomatssaved",False),"Muertos","El Agamemnon fue hundido y todas las vidas a bordo fueron perdidas."],
    
    [1,"Mochi rescue","What did you order during the mission to rescue the Mochi?","True","Rescate del Mochi","¿Qué ordenaste durante la misión para rescatar al Mochi?"],
    [2,"Ryders forward","You sent your ryders ahead to rescue the Mochi.","True",("his_mochirescue",True),"Ryders adelante","Enviaste a tus ryders adelante para rescatar al Mochi."],
    [2,"Defend the Sunrider","You held your ryders back to protect the Sunrider.","True",("his_mochirescue",False),"Defender el Sunrider","Mantuviste a tus ryders atrás para proteger al Sunrider."],
    
    [1,"Medical Malpractice","What did you do after you found out Claude was a fraud?","True","Falta de ética médica","¿Qué hiciste tras averiguar que Claude era un fraude?"],
    [2,"Let Claude off","You let Claude off the hook.","True",("his_claudesupport",True),"Dejar a Claude libre","Dejaste a Claude libre de responsabilidades."],
    [2,"Claude imprisoned","You put her in the brig.","True",("his_claudesupport",False),"Apresar a Claude","La enviaste a la prisión."],
    
    [1,"Chigara's apology","Did you reprimand Chigara for hiding the fact that\nAsaga was the princess of Ryuvia?","True","La disculpa de Chigara","¿Regañaste a Chigara por esconder el hecho de que\nAsaga era la princesa de Ryuvia?"],
    [2,"Forgave Chigara","You forgave Chigara because she was trying to protect Asaga.","True",("his_chigaraforgive",True),"Perdonaste a Chigara","Perdonaste a Chigara porque ella estaba tratando de proteger a Asaga."],
    [2,"Reprimanded Chigara","You reprimanded Chigara for endangering the ship.","True",("his_chigaraforgive",False),"Regañaste a Chigara","Regañaste a Chigara por poner en peligro la nave."],
    
    [1,"Talking with Sola","When you spoke with Sola after Asaga was kidnapped, what did you say?","True","Conversación con Sola","Cuando hablaste con Sola después del secuestro de Asaga, ¿qué dijiste?"],
    [2,"Be careful","You told Sola to watch herself and not do\n anything dangerous.","True",("his_solacareful",True),"Que tuviera cuidado","Le dijiste a Sola que se cuidara y que no hiciera\n nada peligroso."],
    [2,"Give PACT hell","You told Sola to give PACT hell.","True",("his_solacareful",False),"Dar la perdición al PACT","Le dijiste a Sola que le diera la perdición al PACT."],
    
    [1,"Safety regulations","When Icari and Kryska got into a fight about the Phoenix's breach of safety regulations, who did you back?","True","Regulaciones de seguridad","Cuando Icari y Kryska comenzaron una pelea acerca de la violación de regulaciones de seguridad del Phoenix, ¿a quién apoyaste?"],
    [2,"Sided with Icari","You sided with Icari and told Kryska that Alliance\nsafety regulations did not apply in the Neutral Rim.","True",("his_noallianceregulations",True),"Apoyaste a Icari","Estuviste de acuerdo con Icari y le dijiste a Kryska que las regulaciones\nde seguridad de la Alianza no se aplicaban en el Margen Neutral."],
    [2,"Sided with Kryska","You sided with Kryska and told Icari to upgrade\nthe Phoenix to the Alliance's safety regulations.","True",("his_noallianceregulations",False),"Apoyaste a Kryska","Estuviste de acuerdo con Kryska y le dijiste a Icari que mejorara\nal Phoenix de acuerdo a las regulaciones de seguridad de la Alianza."],
    
    [1,"Messhall talk","When Chigara was nervous after meeting Arcadius for the first time, who did you support?","True","Charla en el salón","Cuando Chigara estuvo nerviosa después de conocer a Arcadius por primera vez, ¿a quién apoyaste?"],
    [2,"Sided with Asaga","You agreed with Asaga and told Chigara to be more brave.","True",("his_cafeteriaasaga",True),"Apoyaste a Asaga","Estuviste de acuerdo con Asaga y le dijiste a Chigara que fuera más valiente."],
    [2,"Sided with Chigara","You sided with Chigara and told Asaga not everyone\nwas as macho as her.","True",("his_cafeteriaasaga",False),"Apoyaste a Chigara","Estuviste de acuerdo con Chigara y le dijiste a Asaga que no todo el mundo\nera tan machista como ella."],
    
    [1,"Growing fame","When Icari talked about your growing fame, what did you say you wanted?","True","Creciente fama","Cuando Icari habló sobre tu creciente fama, ¿qué dijiste que querías?"],
    [2,"Not Interested","You said you weren't interested in becoming famous.","True",("his_notinterestedinfame",True),"No interesado","Le dijiste que no estabas interesado en volverte famoso."],
    [2,"Rally against PACT","You said you would use your fame to rally\nthe galaxy against PACT.","True",("his_notinterestedinfame",False),"Unir fuerzas contra el PACT","Le dijiste que usarías tu fama para unir\na la galaxia contra el PACT."],
    
    [1,"The Alliance","Before the Battle of Far Port, what stance did you take with the Alliance?","True","La Alianza","Antes de la Batalla de Far Port, ¿qué posición tomaste con la Alianza?"],
    [2,"Distrust","You suspected the Alliance.","True",("his_beforefarportsuspectalliance",True),"Desconfiar","Sospechaste de la Alianza."],
    [2,"Trust","You trusted the Alliance.","True",("his_beforefarportsuspectalliance",False),"Confiar","Confiaste en la Alianza."],
    
    [1,"Paradox Project","When you discussed the Paradox Project with Chigara over tea, what did you say?","True","Projecto Paradox","Cuando discutiste con Chigara acerca del Paradox Core en la hora del té, ¿qué dijiste?"],
    [2,"Dangerous","You said such technology could be dangerous if misused.","True",("his_techdangerous",True),"Peligroso","Dijiste que tal tecnología podría ser peligrosa si se abusaba de ella."],
    [2,"Useful","You said such technology could be useful now.","True",("his_techdangerous",False),"Útil","Dijiste que tal tecnología podría ser útil ahora."],
    
    [1,"Beach Time 1","Who did you talk with at the beach?","True","Hora de Playa 1","¿Con quién hablaste en la playa?"],
    [2,"Asaga","","his_beach2 != 1 and his_beach3 != 1",("his_beach1",1),"Asaga",""],
    [2,"Chigara","","his_beach2 != 2 and his_beach3 != 2",("his_beach1",2),"Chigara",""],
    [2,"Ava","","his_beach2 != 3 and his_beach3 != 3",("his_beach1",3),"Ava",""],
    [2,"Icari and Kryska","","his_beach2 != 4 and his_beach3 != 4",("his_beach1",4),"Icari and Kryska",""],
    [2,"Claude","","his_beach2 != 5 and his_beach3 != 5",("his_beach1",5),"Claude",""],
    [2,"Sola","","his_beach2 != 6 and his_beach3 != 6",("his_beach1",6),"Sola",""],
    
    [1,"Beach Time 2","Who else did you talk with at the beach?","True","Hora de Playa 2","¿Con quién más hablaste en la playa?"],
    [2,"Asaga","","his_beach1 != 1 and his_beach3 != 1",("his_beach2",1),"Asaga",""],
    [2,"Chigara","","his_beach1 != 2 and his_beach3 != 2",("his_beach2",2),"Chigara",""],
    [2,"Ava","","his_beach1 != 3 and his_beach3 != 3",("his_beach2",3),"Ava",""],
    [2,"Icari and Kryska","","his_beach1 != 4 and his_beach3 != 4",("his_beach2",4),"Icari and Kryska",""],
    [2,"Claude","","his_beach1 != 5 and his_beach3 != 5",("his_beach2",5),"Claude",""],
    [2,"Sola","","his_beach1 != 6 and his_beach3 != 6",("his_beach2",6),"Sola",""],
    
    [1,"Beach Time 3","Who else did you talk with at the beach?","True","Hora de Playa 3","¿Con quién más hablaste en la playa?"],
    [2,"Asaga","","his_beach1 != 1 and his_beach2 != 1",("his_beach3",1),"Asaga",""],
    [2,"Chigara","","his_beach1 != 2 and his_beach2 != 2",("his_beach3",2),"Chigara",""],
    [2,"Ava","","his_beach1 != 3 and his_beach2 != 3",("his_beach3",3),"Ava",""],
    [2,"Icari and Kryska","","his_beach1 != 4 and his_beach2 != 4",("his_beach3",4),"Icari and Kryska",""],
    [2,"Claude","","his_beach1 != 5 and his_beach2 != 5",("his_beach3",5),"Claude",""],
    [2,"Sola","","his_beach1 != 6 and his_beach2 != 6",("his_beach3",6),"Sola",""],
    
    [1,"Sola's mother","When Sola told you about her mother, what did you say?","True","La madre de Sola","Cuando Sola te contó sobre su madre, ¿qué dijiste?"],
    [2,"Naive","Her mother was naive to think the prince\nwould marry her.","True",("his_mothernaive",True),"Ingenua","Su madre fue ingenua al pensar que el príncipe\nse casaría con ella."],
    [2,"Sympathize","You sympathized with her mother.","True",("his_mothernaive",False),"Simpatizar","Simpatizaste con su madre."],
    
    [1,"Sola's past","After Sola told you her history, what did you say?","True","El pasado de Sola","Después de que Sola te contó su historia, ¿qué dijiste?"],
    [2,"Protect her","You promised you would never sacrifice her.","True",("his_solaprotect",True),"Protegerla","Le prometiste que nunca la sacrificarías."],
    [2,"She was brave","You told her she was brave to be willing to\n die for her people.","True",("his_solaprotect",False),"Fue valiente","Le dijiste que ella fue valiente como para desear\nmorir por su gente."],
    
    [1,"Ceran deserters","What did you do when you captured former Ceran sailors who became pirates?","True","Desertores Ceranos","¿Qué hiciste cuando capturaste a los antiguos marines de Cera que se volvieron piratas?"],
    [2,"Acquitted","You acquitted them and allowed them to serve\n on board the Sunrider.","True",("his_acquitteddeserters",True),"Absolverlos","Los absolviste y les permitiste servir\na bordo del Sunirder."],
    [2,"Executed","You executed them under military law.","True",("his_acquitteddeserters",False),"Ejecutarlos","Los ejecutaste bajo la ley militar."],
    
    [1,"The Wishall","Did you sell the wishall?","True","El Wishall","¿Vendiste el wishall?"],
    [2,"Sold","You sold the wishall for 10 000 credits.","True",("his_soldwishall",True),"Vendido","Vendiste el wishall por 10 000 créditos."],
    [2,"Saved","You held onto the wishall.","True",("his_soldwishall",False),"Guardado","Te apropiaste del wishall."],
    
    [1,"The Alliance election","Who did you support in the Alliance election?","True","Las elecciones de la Alianza","¿A quién apoyaste en las elecciones de la Alianza?"],
    [2,"Admiral Grey","You supported Admiral Grey.","True",("his_backgrey",True),"Almirante Grey","Apoyaste al Almirante Grey."],
    [2,"The civilian government","You wanted power to remain with the civilian government.","True",("his_backgrey",False),"El gobierno civil","Quisiste que el poder permaneciera con el gobierno civil."],
    
    [1,"Ongess slums inspection","After your inspection of the Ongess slums, who did you support?","True","Inspección de los barrios de Ongess","Después de la inspección de los barrios bajos de Ongess,\n¿a quién apoyaste?"],
    [2,"The Alliance's relief efforts","You supported the Alliance's relief efforts.","True",("his_supportrelief",True),"Esfuerzos de ayuda de la Alianza","Apoyaste a los esfuerzos de ayuda de la Alianza."],
    [2,"Independence","You supported the Neutral Rim's independence.","True",("his_supportrelief",False),"Independencia","Apoyaste la independencia del Margen Neutral."],
    
    [1,"Collateral casualties","What did you do regarding the civilian deaths\nduring your rescue operation?","True","Daños colaterales","¿Qué hiciste respecto a las muertes civiles\ndurante la operación de tu rescate?"],
    [2,"Go to the press","You went to the press with details of the incident.","True",("his_gotopress",True),"Ir a la prensa","Fuiste a la prensa con los detalles del incidente."],
    [2,"Cover up","You covered the incident up.","True",("his_gotopress",False),"Encubrirlos","Encubriste el incidente."],
    
    [1,"The Alliance","Did you back the Alliance after the Ongess rescue?","True","La Alianza","¿Respaldaste a la Alianza después de la operación en Ongess?"],
    [2,"Trust","You backed the Alliance.","True",("his_backalliance",True),"Confiar","Respaldaste a la Alianza."],
    [2,"Suspicion","You decided the Alliance cannot be trusted.","True",("his_backalliance",False),"Sospechar","Decidiste que la Alianza no era confiable."],
    
    [1,"Grey's gambit","What did you do when Admiral Grey threatened to nuke Ongess unless Fontana withdrew his forces?","True","La estrategia de Grey","¿Qué hiciste cuando el Almirante amenazó con explotar a Ongess a menos de que Fontana retirara sus fuerzas?"],
    [2,"Support","You backed the Admiral.","True",("his_suppportnuke",True),"Apoyar","Apoyaste al Almirante."],
    [2,"Protest","You protested against the Admiral.","True",("his_suppportnuke",False),"Protestar","Protestaste contra el Almirate."],
    
    [1,"Ava's sacrifice","Did you send Ava to activate the Vanguard Cannon?","True","El sacrificio de Ava","¿Enviaste a Ava a activar el Cañón Vanguardia?"],
    [2,"Legion sank","Ava activated the Vanguard Cannon, destroying the Legion.","True",("his_legionsank",True),"Hundir al Legion","Ava activó el Cañón Vanguardia, destruyendo al Legion."],
    [2,"Legion spared","You ordered Ava to remain on the bridge, sparing the Legion.","True",("his_legionsank",False),"Dejar ir al Legion","Le ordenaste a Ava permanecer en el puente, dejando ir al Legion."],
                 ]
