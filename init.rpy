...
# Syntax: Use init 2+ python
 ...
 # Validateing:
    ...
    setoptions = [
    [1,_("Flag"),_("After the fall of Cera, which flag did you suggest flying?"),"True"],
    [2,_("Cera"),_("You told Ava the Sunrider would always fly Cera's flag."),"True",("his_ceraflag",True)],
    [2,_("Pirate"),_("You told Ava being a pirate ship wouldn't be bad."),"True",("his_ceraflag",False)],
    
    [1,_("Reunion with Ava"),_("How did you treat Ava upon reuniting with her\nafter ten years?"),"True"],
    [2,_("Professional"),_("You were professional with Ava."),"True",("his_professionalreunion",True)],
    [2,_("Friendly"),_("You told Ava that it'll be just like old times."),"True",("his_professionalreunion",False)],
    
    [1,_("Military discipline"),_("Who did you support after meeting Asaga and Chigara\nat Tydaria?"),"True"],
    [2,_("Relaxed rules"),_("You loosened up the rules for Asaga."),"True",("his_loosenrule",True)],
    [2,_("Enforced discipline"),_("You supported Ava's enforcement of military discipline."),"True",("his_loosenrule",False)],
    
    [1,_("First side job"),_("Which first side job did you perform?"),"True"],
    [2,_("PACT Spire"),_("You attacked the PACT communication spire."),"True",("his_pactspire",True)],
    [2,_("Human traffickers"),_("You stopped the human traffickers."),"True",("his_pactspire",False)],
    
    [1,_("Fate of the Traffickers"),_("What did you do with the captured human traffickers?"),"his_pactspire == False"],
    [2,_("Taken alive"),_("You captured them and turned them over to the authorities."),"his_pactspire == False",("his_capturetraffickers",True)],
    [2,_("Killed"),_("You left them to die slowly in space."),"his_pactspire == False",("his_capturetraffickers",False)],
    
    [1,_("Versta diplomats"),_("What happened to the Alliance diplomats at Versta?"),"True"],
    [2,_("Saved"),_("You saved the diplomats."),"True",("his_diplomatssaved",True)],
    [2,_("Killed"),_("The Agamemnon was sank and all lives onboard were lost."),"True",("his_diplomatssaved",False)],
    
    [1,_("Mochi rescue"),_("What did you order during the mission to rescue the Mochi?"),"True"],
    [2,_("Ryders forward"),_("You sent your ryders ahead to rescue the Mochi."),"True",("his_mochirescue",True)],
    [2,_("Defend the Sunrider"),_("You held your ryders back to protect the Sunrider."),"True",("his_mochirescue",False)],
    
    [1,_("Medical Malpractice"),_("What did you do after you found out Claude was a fraud?"),"True"],
    [2,_("Let Claude off"),_("You let Claude off the hook."),"True",("his_claudesupport",True)],
    [2,_("Claude imprisoned"),_("You put her in the brig."),"True",("his_claudesupport",False)],
    
    [1,_("Chigara's apology"),_("Did you reprimand Chigara for hiding the fact that\nAsaga was the princess of Ryuvia?"),"True"],
    [2,_("Forgave Chigara"),_("You forgave Chigara because she was trying to protect Asaga."),"True",("his_chigaraforgive",True)],
    [2,_("Reprimanded Chigara"),_("You reprimanded Chigara for endangering the ship."),"True",("his_chigaraforgive",False)],
    
    [1,_("Talking with Sola"),_("When you spoke with Sola after Asaga was kidnapped, what did you say?"),"True"],
    [2,_("Be careful"),_("You told Sola to watch herself and not do\n anything dangerous."),"True",("his_solacareful",True)],
    [2,_("Give PACT hell"),_("You told Sola to give PACT hell."),"True",("his_solacareful",False)],
    
    [1,_("Safety regulations"),_("When Icari and Kryska got into a fight about the Phoenix's breach of safety regulations, who did you back?"),"True"],
    [2,_("Sided with Icari"),_("You sided with Icari and told Kryska that Alliance\nsafety regulations did not apply in the Neutral Rim."),"True",("his_noallianceregulations",True)],
    [2,_("Sided with Kryska"),_("You sided with Kryska and told Icari to upgrade\nthe Phoenix to the Alliance's safety regulations."),"True",("his_noallianceregulations",False)],
    
    [1,_("Messhall talk"),_("When Chigara was nervous after meeting Arcadius for the first time, who did you support?"),"True"],
    [2,_("Sided with Asaga"),_("You agreed with Asaga and told Chigara to be more brave."),"True",("his_cafeteriaasaga",True)],
    [2,_("Sided with Chigara"),_("You sided with Chigara and told Asaga not everyone\nwas as macho as her."),"True",("his_cafeteriaasaga",False)],
    
    [1,_("Growing fame"),_("When Icari talked about your growing fame, what did you say you wanted?"),"True"],
    [2,_("Not Interested"),_("You said you weren't interested in becoming famous."),"True",("his_notinterestedinfame",True)],
    [2,_("Rally against PACT"),_("You said you would use your fame to rally\nthe galaxy against PACT."),"True",("his_notinterestedinfame",False)],
    
    [1,_("The Alliance"),_("Before the Battle of Far Port, what stance did you take with the Alliance?"),"True"],
    [2,_("Distrust"),_("You suspected the Alliance."),"True",("his_beforefarportsuspectalliance",True)],
    [2,_("Trust"),_("You trusted the Alliance."),"True",("his_beforefarportsuspectalliance",False)],
    
    [1,_("Paradox Project"),_("When you discussed the Paradox Project with Chigara over tea, what did you say?"),"True"],
    [2,_("Dangerous"),_("You said such technology could be dangerous if misused."),"True",("his_techdangerous",True)],
    [2,_("Useful"),_("You said such technology could be useful now."),"True",("his_techdangerous",False)],
    
    [1,_("Beach Time 1"),_("Who did you talk with at the beach?"),"True"],
    [2,_("Asaga"),"","his_beach2 != 1 and his_beach3 != 1",("his_beach1",1)],
    [2,_("Chigara"),"","his_beach2 != 2 and his_beach3 != 2",("his_beach1",2)],
    [2,_("Ava"),"","his_beach2 != 3 and his_beach3 != 3",("his_beach1",3)],
    [2,_("Icari and Kryska"),"","his_beach2 != 4 and his_beach3 != 4",("his_beach1",4)],
    [2,_("Claude"),"","his_beach2 != 5 and his_beach3 != 5",("his_beach1",5)],
    [2,_("Sola"),"","his_beach2 != 6 and his_beach3 != 6",("his_beach1",6)],
    
    [1,_("Beach Time 2"),_("Who else did you talk with at the beach?"),"True"],
    [2,_("Asaga"),"","his_beach1 != 1 and his_beach3 != 1",("his_beach2",1)],
    [2,_("Chigara"),"","his_beach1 != 2 and his_beach3 != 2",("his_beach2",2)],
    [2,_("Ava"),"","his_beach1 != 3 and his_beach3 != 3",("his_beach2",3)],
    [2,_("Icari and Kryska"),"","his_beach1 != 4 and his_beach3 != 4",("his_beach2",4)],
    [2,_("Claude"),"","his_beach1 != 5 and his_beach3 != 5",("his_beach2",5)],
    [2,_("Sola"),"","his_beach1 != 6 and his_beach3 != 6",("his_beach2",6)],
    
    [1,_("Beach Time 3"),_("Who else did you talk with at the beach?"),"True"],
    [2,_("Asaga"),"","his_beach1 != 1 and his_beach2 != 1",("his_beach3",1)],
    [2,_("Chigara"),"","his_beach1 != 2 and his_beach2 != 2",("his_beach3",2)],
    [2,_("Ava"),"","his_beach1 != 3 and his_beach2 != 3",("his_beach3",3)],
    [2,_("Icari and Kryska"),"","his_beach1 != 4 and his_beach2 != 4",("his_beach3",4)],
    [2,_("Claude"),"","his_beach1 != 5 and his_beach2 != 5",("his_beach3",5)],
    [2,_("Sola"),"","his_beach1 != 6 and his_beach2 != 6",("his_beach3",6)],
    
    [1,_("Sola's mother"),_("When Sola told you about her mother, what did you say?"),"True"],
    [2,_("Naive"),_("Her mother was naive to think the prince\nwould marry her."),"True",("his_mothernaive",True)],
    [2,_("Sympathize"),_("You sympathized with her mother."),"True",("his_mothernaive",False)],
    
    [1,_("Sola's past"),_("After Sola told you her history, what did you say?"),"True"],
    [2,_("Protect her"),_("You promised you would never sacrifice her."),"True",("his_solaprotect",True),],
    [2,_("She was brave"),_("You told her she was brave to be willing to\n die for her people."),"True",("his_solaprotect",False)],
    
    [1,_("Ceran deserters"),_("What did you do when you captured former Ceran sailors who became pirates?"),"True"],
    [2,_("Acquitted"),_("You acquitted them and allowed them to serve\n on board the Sunrider."),"True",("his_acquitteddeserters",True)],
    [2,_("Executed"),_("You executed them under military law."),"True",("his_acquitteddeserters",False)],
    
    [1,_("The Wishall"),_("Did you sell the wishall?"),"True","El Wishall","¿Vendiste el wishall?"],
    [2,_("Sold"),_("You sold the wishall for 10 000 credits."),"True",("his_soldwishall",True)],
    [2,_("Saved{#wishall}"),_("You held onto the wishall."),"True",("his_soldwishall",False)],
    
    [1,_("The Alliance election"),_("Who did you support in the Alliance election?"),"True"],
    [2,_("Admiral Grey"),_("You supported Admiral Grey."),"True",("his_backgrey",True)],
    [2,_("The civilian government"),_("You wanted power to remain with the civilian government."),"True",("his_backgrey",False)],
    
    [1,_("Ongess slums inspection"),_("After your inspection of the Ongess slums, who did you support?"),"True"],
    [2,_("The Alliance's relief efforts"),_("You supported the Alliance's relief efforts."),"True",("his_supportrelief",True)],
    [2,_("Independence"),_("You supported the Neutral Rim's independence."),"True",("his_supportrelief",False)],
    
    [1,_("Collateral casualties"),_("What did you do regarding the civilian deaths\nduring your rescue operation?"),"True"],
    [2,_("Go to the press"),_("You went to the press with details of the incident."),"True",("his_gotopress",True)],
    [2,_("Cover up"),_("You covered the incident up."),"True",("his_gotopress",False)],
    
    [1,_("The Alliance"),_("Did you back the Alliance after the Ongess rescue?"),"True"],
    [2,_("Trust"),_("You backed the Alliance."),"True",("his_backalliance",True)],
    [2,_("Suspicion"),_("You decided the Alliance cannot be trusted."),"True",("his_backalliance",False)],
    
    [1,_("Grey's gambit"),_("What did you do when Admiral Grey threatened to nuke Ongess unless Fontana withdrew his forces?"),"True"],
    [2,_("Support"),_("You backed the Admiral."),"True",("his_suppportnuke",True)],
    [2,_("Protest"),_("You protested against the Admiral."),"True",("his_suppportnuke",False)],
    
    [1,_("Ava's sacrifice"),_("Did you send Ava to activate the Vanguard Cannon?"),"True"],
    [2,_("Legion sank"),_("Ava activated the Vanguard Cannon, destroying the Legion."),"True",("his_legionsank",True)],
    [2,_("Legion spared"),_("You ordered Ava to remain on the bridge, sparing the Legion."),"True",("his_legionsank",False)],
    ]
