...
init -1 python hide:
    ...
    config.window_title = u"Sunrider Liberation Day"
    ...
    config.main_menu_music = "Music/Colors_of_an_Orchestra_II.ogg"
...
python early:
    config.save_directory = "Sunrider Liberation Day-1433059539"
...
init python:
    ...
    build.directory_name = "SunriderLiberationDay-DecensorMod"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Sunrider Liberation Day"
