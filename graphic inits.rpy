...
#####################################SPACE BACKGROUNDS
    ...
    image map_ongess_info:
        "Map/ongess_info.png"
    image map_pacemus_info:
        "Map/pacemus_info.png"
    ...
    $ screenwipe = ImageDissolve("UI/transistion_blinds.jpg", 1, reverse=False)
    $ screenwipefast = ImageDissolve("UI/transistion_blinds.jpg", 0.4, reverse=False)
    $ screenwipereverse = ImageDissolve("UI/transistion_blinds.jpg", 1, reverse=True)
    $ battlewipe = ImageDissolve("UI/transistion_battle.jpg", 2, reverse=False)
    $ dissolvequick = Dissolve(0.1)
    $ dissolvemedium = Dissolve(0.3)
    $ dissolvelong = Dissolve(2.0)
    $ dissolvelonglong = Dissolve(6.0)
    
    $ wipeup = ImageDissolve("UI/up_to_down.jpg", 1, reverse=True)
    $ wipedown = ImageDissolve("UI/up_to_down.jpg", 1, reverse=False)
    $ horizontalwipe = ImageDissolve("UI/left_to_right.jpg", 1, reverse=True)
    $ swordwipe = ImageDissolve("UI/left_to_right.jpg", 2.5, reverse=False, time_warp = time_warp_easeout)
    $ swordwipereverse = ImageDissolve("UI/left_to_right.jpg", 0.1, reverse=False)
    $ horizontalwipereverse = ImageDissolve("UI/left_to_right.jpg", 1, reverse=False)
    $ horizontalwipereversefast = ImageDissolve("UI/left_to_right.jpg", 0.5, reverse=False)
    
    $ laserwipe = ImageDissolve("UI/left_to_right.jpg", 0.5, reverse=True)
    $ sunridermissilewipe = ImageDissolve("UI/sunrider_missiles.jpg", 1, reverse=True)
    $ sunriderrocketwipe = ImageDissolve("UI/left_to_right.jpg", 1.2, reverse=True)
    $ sunriderhitrocketwipe = ImageDissolve("UI/left_to_right.jpg", 1.2, reverse=False)
    $ sunridermissilehitwipe = ImageDissolve("UI/left_to_right.jpg", 1.35, reverse=False)
    
    $ pactmissilefrigate_missilewipe = ImageDissolve("UI/left_to_right.jpg", 0.85, reverse=False)    
    $ pactmissilefrigate_missilehitwipe = ImageDissolve("UI/left_to_right.jpg", 1, reverse=True)
    $ pactmissilefrigate_laserhitwipe = ImageDissolve("UI/left_to_right.jpg", 0.5, reverse=True)
    $ pactmissilefrigate_rockethitwipe = ImageDissolve("UI/left_to_right.jpg", 2.1, reverse=True)
    $ piratestation_missilewipe = ImageDissolve("UI/left_to_right.jpg", 1.2, reverse=False)    
    $ piratebomber_missilewipe = ImageDissolve("UI/left_to_right.jpg", 0.9, reverse=False)    

    $ enemy_laserhitwipe = ImageDissolve("UI/left_to_right.jpg", 0.5, reverse=False)
    $ enemy_laserhitwipequick = ImageDissolve("UI/left_to_right.jpg", 0.2, reverse=False)
    $ blackjack_missilewipe = ImageDissolve("UI/left_to_right.jpg", 0.87, reverse=True)
    
    $ meleehit = ImageDissolve("UI/left_to_right.jpg", 0.3, reverse=False)
    $ meleehitreverse = ImageDissolve("UI/left_to_right.jpg", 0.3, reverse=True)

    $ eyecatch_wipe = ImageDissolve("UI/left_to_right.jpg", 0.5, reverse=False)
    $ eyecatch_wiperev = ImageDissolve("UI/left_to_right.jpg", 0.5, reverse=True)
    
    $ nightmaremissilewipe = ImageDissolve("UI/left_to_right.jpg", 0.5, reverse=False)
